      ...
      <div className="container-xl py-4">
        <div className="row">
          ...
          <div className="col-12 d-sm-none">
            <button className="btn btn-light btn-block mb-4" type="button" data-toggle="collapse" data-target="#sidebarCollapse" aria-expanded="false" aria-controls="sidebarCollapse">
              Menú de navegación
            </button>
