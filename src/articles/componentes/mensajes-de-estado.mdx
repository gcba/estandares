...
<div class="content-1">
  <div class="status status-success">
    <h2 class="status-title">Este es un mensaje de éxito</h2>
    <p class="status-text">
      Esto es un párrafo que acompaña y sirve para indicar que el usuario realizó una acción correctamente, como cuando
      realiza una tarea con éxito.
    </p>
...
<div class="content-1">
  <div class="status status-primary">
    <h2 class="status-title">Este es un mensaje de advertencia</h2>
    <p class="status-text">
      Esto es un párrafo que acompaña y sirve para indicar que el usuario realizó una acción correctamente, como cuando
      realiza una tarea con éxito.
    </p>
...
<div class="content-1">
  <div class="status status-info">
    <h2 class="status-title">Este es un mensaje de información</h2>
    <p class="status-text">
      Esto es un párrafo que acompaña y sirve para indicar que el usuario realizó una acción correctamente, como cuando
      realiza una tarea con éxito.
    </p>
...
<div class="content-1">
  <div class="status status-danger">
    <h2 class="status-title">Este es un mensaje de error</h2>
    <p class="status-text">
      Esto es un párrafo que acompaña y sirve para indicar que el usuario realizó una acción correctamente, como cuando
      realiza una tarea con éxito.
    </p>
...
![completar](/componentes/mensajedeestado/diagrama.svg)
...
[[si | **Brindar la información de forma ordenada.** Jerarquizar a través de los estilos tipográficos y el tamaño de la fuente.]]

### Malas prácticas

[[no | **Evitar excederse en la cantidad de Mensajes de Estados dentro de un mismo proceso o flujo.**]]
