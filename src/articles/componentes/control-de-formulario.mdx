...
<div class="content-3">
  <div class="btn-wrapper" data-toggle="buttons">
    <label class="btn btn-chip btn-sm mx-2">
      <input type="radio" name="options1" id="option1" class="btn-check" />
      Botón
    </label>
    <label class="btn btn-chip btn-sm mx-2 active">
      <input type="radio" name="options2" id="option2" class="btn-check" checked="" />
      Botón
    </label>
    <label class="btn btn-chip btn-sm mx-2 disabled">
      <input type="radio" name="options3" id="option3" class="btn-check" />
      Botón
    </label>
  </div>
</div>
