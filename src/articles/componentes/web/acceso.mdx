...
<div className="content-2">
  <div class="list-group">
    <a href="#" class="list-group-item item-sm no-shadow">
    ...
    <div class="group-access">
      <div class="card-access">
        <div class="card-access-body">
          <span class="card-access-icon descriptive">Nº</span>
          <div>
            <h3 class="card-access-title">Título del acceso</h3>
      ...
      <div class="card-access">
        ...
        <div class="container-access">
          ...
          <div class="access-option">
            ...
            <hr class="clearfix my-0 mt-2" />
          </div>
        </div>
        <a href="#" class="list-group-item card-item no-shadow">
          <span class="access-title">
            <i class="bx bxs-info-circle"></i>
            Acceso grande
          </span>
    ...
    <div class="group-access">
      <div class="card-access">
        ...
        <div class="container-access">
          <hr class="clearfix mt-0" />
          <div class="access-option">
            <h2 class="title-option font-weight-bold">Categoría 1</h2>
            <a href="#" class="list-group-item item-sm">
              <span class="access-title">
                <i class="bx bxs-info-circle"></i>
                Acceso chico
            ...
            <hr class="clearfix clearfix-category" />
            <h2 class="title-option font-weight-bold">Categoría 2</h2>
            <a href="#" class="list-group-item item-sm">
              <span class="access-title">
                <i class="bx bxs-info-circle"></i>
                Acceso chico
