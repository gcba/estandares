---
menu: De selección
title: Desplegables de selección
...
<div className="content-3 mt-5 justify-content-between align-items-start flex-wrap">
...
<div className="content-3 align-items-start flex-wrap flex-lg-nowrap gap-2 justify-content-center mt-4">
  <div className="w-75 w-lg-50">
    <img src="/componentes/desplegable/desplegable-radio.svg" alt="desplegables seleccion unica"  className="m-0 w-100"/>
  </div>
  <div className="w-75 w-lg-50">
    <img src="/componentes/desplegable/desplegable-radio-ok.svg" alt="desplegable con opcion unica seleccionada"  className="m-0 w-100"/>
  </div>
</div>
...
<div className="content-3 align-items-start flex-wrap flex-lg-nowrap gap-2 justify-content-center mt-4">
  <div className="w-75 w-lg-50">
      <img src="/componentes/desplegable/desplegable-check.svg" alt="desplegables checkbox"  className="w-100 mt-2"/>
  </div>
  <div className="w-75 w-lg-50">
    <img src="/componentes/desplegable/desplegable-check-ok.svg" alt="desplegable con opcion checkbox seleccionada"  className=" w-100 mt-2"/>
  </div>
</div>
...
<div className="pt-3 pb-5">
  <div className="card py-3 px-4 m-auto w-fit-content">
    <div className="d-flex justify-content-center">
      <img src="/componentes/desplegable/grid.svg" alt="Maximo de columnas que ocupa un desplegable" className="" />
    </div>
  </div>
</div>
...
<div className="gap-2 d-flex flex-wrap">
  <img src="/componentes/desplegable/modalidad.svg" alt="Desplegable con texto corto" className="m-0"/>
  <img src="/componentes/desplegable/tipo-de-info.svg" alt="Desplegable con texto largo" className="m-0"/>
</div>
...
<div className="content-3 align-items-start flex-wrap gap-2 justify-content-center mt-4">
  <img src="/componentes/desplegable/comb-1.svg" alt="desplegables seleccion unica" className="m-0"/>
  <img src="/componentes/desplegable/comb-2.svg" alt="desplegable seleccion multiple" className="m-0"/>
  <img src="/componentes/desplegable/comb-3.svg" alt="boton de aplicar filtros" className="m-0"/>
</div>
