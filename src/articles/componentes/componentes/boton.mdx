...
import { Button, Spinner } from "@gcba/obelisco"
...
<div className="button-container justify-content-center">
  <Button type="primary" size="large" isIconSpinner={<Spinner type="dark" size="small"></Spinner>}>
    Botón
  </Button>
  <Button type="primary" size="large" isIconSpinner={<Spinner type="dark" size="small"></Spinner>} isOutline>
    Botón
  </Button>
</div>
  ...
  <div class="modal d-block position-static" tabindex="-1" role="dialog" id="exampleModal">
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        <div class="modal-header"><h4 class="modal-title">¡Importante!</h4></div>
        <div class="modal-body"><p>Antes de realizar la ficha de salud, tené en cuenta haber realizado los pasos previos correspondientes.</p></div>
