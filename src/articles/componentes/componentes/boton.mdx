...
<div className="button-container">
  ...
  <Button type="secondary" size="large" outline={true}>
    Botón
  </Button>
  <Button type="success" size="large" outline={true}>
    Botón
  </Button>
  <Button type="danger" size="large" outline={true}>
    Botón
  </Button>
  <Button type="link" size="large" outline={true}>
    Botón
  </Button>
</div>
...
<div className="button-container">
  <Button type="secondary" size="large" iconBx="bx-search-alt-2">
    Botón
  </Button>
</div>
...
<div className="button-container">
  <Button type="link" size="large" iconBx="bxs-plus-circle"></Button>
</div>
