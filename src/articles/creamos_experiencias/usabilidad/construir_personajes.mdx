...
## ¿Qué es y qué _no_ es una Persona?
...
Alan Cooper creó el **método _Personas_**, en el que se construyen arquetipos basados en patrones de comportamiento con el propósito de ser una herramienta de comunicación durante el diseño de un producto.
