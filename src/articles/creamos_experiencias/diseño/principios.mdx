...
Diseño Atómico cuenta con 5 etapas:
...
- Moléculas: unión de 2 o más átomos, para formar un elemento de UI relativamente simple que funciona como una unidad. Etiquetas, un input + un botón.
- Organismos: unión de 2 o más moléculas. Son componentes de UI + complejos, formados por átomos, moléculas u otros organismos. Forman secciones distintas y con mayor complejidad. Pop up, footer, menú
- Plantillas (template): organizan los componentes y organismos en un layout. Más centrado en la estructura de la página que en contenido final. Es el esqueleto del producto digital. Plantilla de la página “Home”
- Páginas: es el diseño final, con imágenes, textos y detalles que hace que este listo para testarlo o desarrollarlo.
