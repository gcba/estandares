---
menu: Instalación
title: Instalación de Obelisco en tu proyecto
...
Para agilizar y hacer más transparente el proceso, cualquier persona puede [contribuir de varias formas](https://github.com/gcba/Obelisco/blob/master/CONTRIBUTING.md).